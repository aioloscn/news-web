document.write("<link rel='stylesheet' href='../../layui/layer.css'>")
document.write("<script type='text/text/javascript' src='../../layui/layer.js'></script>");
window.app = {
...
//  prod
 ...
 //    adminServerUrl: "https://www.aiolosxhx.com/news/admin",      // 运营管理服务后端接口地址
 //    articleServerUrl: "https://www.aiolosxhx.com/news/article",      // 文章服务后端接口地址
	
	// cookieDomain: ".aiolosxhx.com",  
    ...
    judgeWriterLogin() {
        ...
        if ( me.isEmpty(utoken) || me.isEmpty(uid)) {
            layer.msg("请登录后再使用媒体中心的相关页面！", function() {
    ...
    judgeUserLoginStatus: function(pageVue) {
        ...
        if ( me.isNotEmpty(utoken) && me.isNotEmpty(uid)) {
            ...
            if (me.isNotEmpty(userInfo)) {
                ...
                axios.post(
                        userServerUrl + '/user/getUserBasicInfo?userId=' + uid,
                        {}, 
                        {
                            headers: {
                                'headerUserId': uid,
